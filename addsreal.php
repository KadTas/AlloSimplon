...
<body>
    ...
    ?>
    <div id=container>
    <p>Ajout de réalisateur</p>
    <form action="addrealdone.php" method="POST" id=add>
    <div>
    ...
    <div>
        <select name="nomreal" id="nomreal" required>
        <?php 
    $reqreal = $bdd->prepare('SELECT * FROM realisateur');
    $reqreal->execute();
    while ($resultatreal = $reqreal->fetch()) {
    ?>
        <option value="<?php echo $resultatreal['id'] ?>"><?php echo  $resultatreal['nom'] ?></option>
    <?php } ?>
    </select>
    </div>
    <div>
